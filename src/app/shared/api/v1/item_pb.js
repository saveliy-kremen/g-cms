 ...
 * @const
 */
proto.v1.Item.repeatedFields_ = [19];
 ...
 * @const
 */
proto.v1.EditItemRequest.repeatedFields_ = [12,13,14];
...
proto.v1.EditItemRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    itemImagesList: (f = jspb.Message.getRepeatedField(msg, 12)) == null ? undefined : f,
    uploadImagesList: (f = jspb.Message.getRepeatedField(msg, 13)) == null ? undefined : f,
...
proto.v1.EditItemRequest.prototype.getPropertiesList = function() {
  return /** @type{!Array<!proto.v1.ItemProperty>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.v1.ItemProperty, 14));
};
...
proto.v1.EditItemRequest.prototype.addProperties = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 14, opt_value, proto.v1.ItemProperty, opt_index);
};
